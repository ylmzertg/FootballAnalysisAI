...
def parse_args():
    ...
    p.add_argument(
        "--output",
        default=r"output\team_classification_v21.mp4",
    )
    p.add_argument(
        "--jsonl",
...
def main():
    ...
    print("=" * 82)
    print("FootballAnalysisAI - Team Classifier V2.1 ROLE-GUARD")
    print("Harness version    : 2.1-role-guard-final")
        ...
        try:
            while True:
                ...
                cv2.putText(
                    frame,
                    (
                        f"Team Classifier V2.1 | {ready_text} | "
    ...
    print("=" * 82)
    print("DONE - Team Classifier V2.1 ROLE-GUARD")
