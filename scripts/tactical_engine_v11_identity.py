...
def parse_args():
    p = argparse.ArgumentParser(
        description="FootballAnalysisAI - Pressure + Passing Lanes Tactical Engine v1.1 IDENTITY-AWARE"
    )
...
def main():
    ...
    print("=" * 86)
    print(
        "FootballAnalysisAI - Tactical Engine v1.1 IDENTITY-AWARE "
    ...
    with jsonl_out.open(
        ...
        try:
            while frame_index <= last_frame:
                ...
                cv2.putText(
                    frame,
                    f"Tactical Engine v1.1 IDENTITY-AWARE | Possession={state} | Owner={possessor_id}",
                    (18, 30),
    ...
    print("=" * 86)
    print("DONE - Tactical Engine v1.1 IDENTITY-AWARE")
