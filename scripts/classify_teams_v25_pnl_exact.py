...
def parse_args():
    p = argparse.ArgumentParser(
        description=(
            "FootballAnalysisAI - Team Classifier V2.5 + PnLCalib + Canonical ID spatial role gate"
        )
    )
    p.add_argument(
        "--source",
    ...
    p.add_argument(
        "--output",
        default=r"output\team_classification_v25_pnl_exact.mp4",
    )
    p.add_argument(
        "--jsonl",
    ...
    p.add_argument(
        ...
        default=r"output\v25_pnl_frames_exact",
    )
    p.add_argument(
        "--calibration-stride",
        type=int,
        default=1,
        help=(
            "V2.5 validation defaults to exact per-frame PnLCalib. "
    ...
    p.add_argument(
        ...
        type=int,
        default=0,
        help="V2.5 exact validation does not reuse nearby homographies by default.",
    )
    p.add_argument(
...
def main():
    ...
    print("=" * 92)
    print("FootballAnalysisAI - Team Classifier V2.5 + PnLCalib + Canonical ID")
    ...
    # V2.5 canonical identity prepass. This is deliberately strict: only tracks
    ...
    print("[V2.5] Canonical duplicate-track pairs:")
    if duplicate_pairs:
    ...
    print("=" * 92)
    print("DONE - Team Classifier V2.5 + PnL + CANONICAL ID")
